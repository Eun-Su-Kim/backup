	...
	SparseMatrix Add(SparseMatrix b) {
		...
		while (aPos <terms && bPos < b.terms) {
				if ((smArray[aPos].row == b.smArray[bPos].row) && (smArray[aPos].col == b.smArray[bPos].col)) {
					c.StoreSum(smArray[aPos].value + b.smArray[bPos].value, smArray[aPos].row, smArray[aPos].col);
					aPos++;
					bPos++;
					...
					c.NewTerm(smArray[aPos].row, b.smArray[bPos].col, b.smArray[bPos].value);
					bPos++;
